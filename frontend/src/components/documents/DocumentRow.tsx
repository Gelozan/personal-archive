...
export default function DocumentRow({ document, onClick, onShare, onTrash, onDownload, onMove,
    draggable, onDragStart, onDragEnd, longPressHandlers }: DocumentRowProps) {
